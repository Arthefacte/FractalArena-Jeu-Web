...
(function () {
  ...
  const T = {
    ...
    RES_BURN: { FR: "Verrouillé / Rachat", EN: "Locked / Buyback", ZH: "锁定 / 回购" },
    BB_RESERVE:    { FR: "Réserve de rachat", EN: "Buyback reserve", ZH: "回购储备" },
    BB_LIQ:        { FR: "Liquidité verrouillée", EN: "Locked liquidity", ZH: "锁定流动性" },
    BB_BOUGHT:     { FR: "Racheté à vie",      EN: "Bought back for life", ZH: "永久回购" },
    BB_BOUGHT_SUB: { FR: "· %s FA rachetés à vie", EN: "· %s FA bought back for life", ZH: "· 累计回购 %s FA" },
