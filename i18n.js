...
(function () {
  ...
  const T = {
    ...
    EXP_MODE_PRUDENT_SUB: { FR: "Butin ×1 · taux max 90 %", EN: "Loot ×1 · 90% rate cap", ZH: "战利品×1·成功率上限90%" },
    EXP_MODE_RISKY: { FR: "Risquée", EN: "Risky", ZH: "冒险" },
    EXP_MODE_RISKY_SUB: { FR: "Butin ×1,5 · taux max 70 %", EN: "Loot ×1.5 · 70% rate cap", ZH: "战利品×1.5·成功率上限70%" },
