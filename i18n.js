...
(function () {
  ...
  const T = {
    ...
    BO_ARM_HINT: { FR: "Un boost n'agit que si tu l'armes — dans la Fosse ou ici. Armé, il se consomme tout seul au fil des combats, loop comprise.", EN: "A boost only works once you arm it — in the Pit or here. Armed, it consumes itself as you fight, loop included.", ZH: "强化只有在你启用后才生效——在深渊或此处启用。启用后会随战斗自动消耗，循环模式也一样。" },
    BO_STATE_ARMED: { FR: "Armé", EN: "Armed", ZH: "已启用" },
    BO_STATE_OFF: { FR: "Désarmé", EN: "Off", ZH: "未启用" },
    BO_ARMED_ON: { FR: "Boost armé", EN: "Boost armed", ZH: "强化已启用" },
    BO_ARMED_OFF: { FR: "Boost désarmé", EN: "Boost disarmed", ZH: "强化已停用" },
