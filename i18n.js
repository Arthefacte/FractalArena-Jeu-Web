...
(function () {
  ...
  const T = {
    ...
    CORE_SUMMON_HINT: { FR: "Effet déclenché en combat — 1 slot par entité, rareté Common", EN: "Combat-triggered effect — 1 slot per creature, Common rarity", ZH: "战斗触发效果 — 每个生物 1 个槽位，普通稀有度" },
