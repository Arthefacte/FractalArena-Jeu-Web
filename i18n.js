...
(function () {
  ...
  const T = {
    ...
    UAPP_STEP3_LINK: { FR: "3. Ouvre le navigateur de l'app UniSat et colle le lien : tu retrouves ton compte tel quel — touche « Lier mon portefeuille UniSat ».", EN: "3. Open the UniSat app's browser and paste the link: your account is right there — tap “Link my UniSat wallet”.", ZH: "3. 打开 UniSat 应用内浏览器并粘贴链接：你的账号原样呈现——点按「绑定我的 UniSat 钱包」。" },
    UAPP_STEP3_WD: { FR: "3. Ouvre le navigateur de l'app UniSat et colle le lien : tu retrouves ton compte tel quel, et le retrait se signe là-bas.", EN: "3. Open the UniSat app's browser and paste the link: your account is right there, and the withdrawal is signed there.", ZH: "3. 打开 UniSat 应用内浏览器并粘贴链接：你的账号原样呈现，提现在那里签名完成。" },
