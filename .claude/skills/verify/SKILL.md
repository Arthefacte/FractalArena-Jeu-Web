...
- Seed via `page.addInitScript` : intercepter `Object.defineProperty(window, "FA_TALENTS_UI", { set })`
  ...
  `localStorage.setItem("fractal_arena_v1", JSON.stringify({ roster, view: "team", lang: "FR", wallet: "bc1q<factice>", options: { sound: false, speed: 1 } }))`
...
- L'option `anim` a été SUPPRIMÉE (2026-07-10, anti-farm : elle réduisait le déroulé de combat de 165→42 ms/event).
  Les combats jouent toujours leurs animations ; prévoir des timeouts en conséquence dans les vérifs de combat.
