...
function plancherCumul(prev, next) {
  ...
  if (next && vn >= vp) return {
    value: vn,
    source: next.source || "tranches"
  };
  if (prev) return {
    value: vp,
    source: prev.source || "tranches"
  };
  return {
    value: 0,
    source: "tranches"
...
function lireCumulOnChain(storage) {
  try {
    return storage ? nombrePositif(storage.getItem(BB_CUMUL_KEY)) : 0;
  } catch (e) {
    return 0;
  }
}
...
function RangeeBurn({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    ...
    className: "bb-label"
  }, I.t("BURN_POOL_LABEL")), /*#__PURE__*/React.createElement("div", {
    className: "bb-bar"
  }, /*#__PURE__*/React.createElement("i", {
    style: {
      width: frac * 100 + "%"
    }
  })), gain.montant > 0 && /*#__PURE__*/React.createElement("span", {
    className: "bb-delta"
  }, "+", bbFmt(gain.montant)), /*#__PURE__*/React.createElement("span", {
    className: "bb-nums"
...
function BuybackTicker() {
  ...
  }, rows.map((p, i) => /*#__PURE__*/React.createElement(TickerRow, {
