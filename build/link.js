/* Généré par tools/precompile.mjs depuis link.jsx — NE PAS ÉDITER. */
(function () {
/* ============================================================
...
function Link() {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    }, I18N.t("TOTEM_GALLERY_TITLE")), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 12,
        opacity: 0.75,
        marginBottom: 8
      ...
      key: it.tier,
      alt: TU.tierName(it.tier),
      src: it.url,
      onError: e => {
        e.currentTarget.onerror = null;
        e.currentTarget.src = TU.totemArtFallback(t.type);
      },
