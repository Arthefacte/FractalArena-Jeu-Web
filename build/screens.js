...
function Team() {
  ...
  async function designate(b) {
    ...
    if (r.ok) toast(I18N.t("CHAMP_DESIGNATED_OK", D.displayName(b)), "good");else toast(I18N.localizeServerError(r.reason), "bad");
  }
  function toggle(b) {
...
function Forge() {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    onClick: () => setTab(t.k)
  }, I18N.t("FG_" + t.k.toUpperCase())))), tab === "fusion" && /*#__PURE__*/React.createElement(ForgeFusion, null), tab === "reroll" && /*#__PURE__*/React.createElement(ForgeReroll, null), tab === "summon" && /*#__PURE__*/React.createElement(ForgeSummon, null), tab === "reliques" && /*#__PURE__*/React.createElement(ForgeReliques, null), tab === "cores" && /*#__PURE__*/React.createElement(ForgeCores, null));
}
...
function ForgeReroll() {
  ...
  async function onKeep() {
    ...
    if (r.ok) {
      setPreview(null);
      toast(I18N.t("REROLL_KEPT_OLD", r.refunded || 0), "good");
    } else toast(I18N.localizeServerError(r.reason), "bad");
  }
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    className: "flex between center wrap",
...
function ForgeFragments({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    }, I18N.t("EXP_FRAG_LINE", rk, have)), /*#__PURE__*/React.createElement("b", {
      className: "mono",
      style: {
        flex: "none",
        color: ready ? col : "var(--text-dim)"
      }
...
function ForgeCoreFragments({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    }, I18N.t("EXP_FRAG_CORE_LINE", rk, have)), /*#__PURE__*/React.createElement("b", {
      className: "mono",
      style: {
        flex: "none",
        color: ready ? col : "var(--text-dim)"
...
function ForgeCoreEquipement({
  ...
  function clic(inst) {
    ...
    if (next === null) {
      toast(I18N.t("FG_CORE_EQ_SEL_MAX"), "bad");
      return;
    }
    setSel(next);
    setConfirmDis(false);
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "\u2B21 ", I18N.t("FG_CORE_EQ_TITLE")), /*#__PURE__*/React.createElement("div", {
    className: "mono muted",
    style: {
      fontSize: 12,
      marginBottom: 14
    }
  }, I18N.t("FG_CORE_EQ_SUB")), cores.length === 0 ? /*#__PURE__*/React.createElement("div", {
    className: "mono muted",
    style: {
      fontSize: 13
    }
  }, I18N.t("FG_CORE_NONE")) : /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    className: "mono muted",
    style: {
      fontSize: 12,
      marginBottom: 8
    }
  }, I18N.t("FG_CORE_INVENTORY")), /*#__PURE__*/React.createElement("div", {
    className: "grid-cards"
  }, cores.map(inst => {
    const selected = sel.some(x => x.id === inst.id);
    const holder = g.roster.find(b => b.core_id === inst.id);
    ...
    }, coreName(inst))), /*#__PURE__*/React.createElement("span", {
      style: {
        color: D.RARITY_COLORS[inst.rarity],
        fontWeight: 600,
        fontSize: 12
    ...
    }, coreDesc(inst)), holder && /*#__PURE__*/React.createElement("span", {
      className: "pill",
      style: {
        color: "var(--gold)",
        fontSize: 11
  ...
  }, I18N.t("FG_CORE_EQ_MAX_RARITY")), fuse.cost != null && !fuse.maxRarity && /*#__PURE__*/React.createElement("div", {
    className: "mono muted",
    style: {
      fontSize: 12,
      marginBottom: 8
  ...
  }, I18N.t("FG_CORE_EQ_DIS_CONFIRM")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
      gridTemplateColumns: "minmax(0,1fr) minmax(0,1fr)",
      gap: 8
...
function ForgeCores() {
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(ForgeCoreSummon, {
    ...
    onForged: setLast
  }), /*#__PURE__*/React.createElement(ForgeCoreEquipement, {
    onForged: setLast
  }));
}
