/* Généré par tools/precompile.mjs depuis campaign.jsx — NE PAS ÉDITER. */
(function () {
/* ============================================================
...
function Stars({
  ...
  for (let i = 0; i < max; i++) {
    out.push(/*#__PURE__*/React.createElement("span", {
      key: i,
      style: {
        color: i < n ? "var(--gold)" : "var(--text-faint)",
        fontSize: fs,
        lineHeight: 1
      }
    }, i < n ? "★" : "☆"));
...
function CampaignCombat({
  ...
  useEffect(() => {
    if (!playing) {
      ...
      const lives = selectedBeasts.map(b => ({
        hp: D.eff(b, "hp"),
        maxHp: D.eff(b, "hp"),
        alive: true
      }));
  ...
  async function startFight() {
    if (playing) return;
    if (!ready) {
      toast(I18N.t(champ ? "CHAMP_NEED2" : "CAMP_NEED3"), "bad");
      return;
    }
    ...
    enemies.forEach(e => {
      if (e.is_boss) e.custom_name = bossName;
    });
    ...
    if (champ) {
      ...
      metas.push(u ? {
        name: champ.beast.name,
        rarity: champ.beast.rarity,
  ...
  function settle() {
    ...
    const summary = {
      ...
      titleUnlocked: r.titleUnlocked || null,
      legend: !!r.legend
    };
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    onClick: onBack,
    disabled: playing
  }, I18N.t("CAMP_BACK_FLOORS")), /*#__PURE__*/React.createElement("div", {
    className: "h1",
    style: {
      marginBottom: 0,
      marginTop: 8
    }
  }, worldName, " \xB7 ", I18N.t("CAMP_FLOOR", floorIndex + 1, D.FLOORS_PER_WORLD), isBoss && /*#__PURE__*/React.createElement("span", {
    style: {
      color: "var(--gold)",
      marginLeft: 10,
      fontSize: 16
  ...
  }, "campaign://pve")), /*#__PURE__*/React.createElement("div", {
    className: "log",
    ref: logRef,
    style: {
      flex: 1,
    ...
    className: "lc-dim"
  }, "> ", I18N.t("CAMP_FIGHT"), "\u2026"), logLines.map((l, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    ...
    style: {
      fontSize: 11,
      textAlign: "center",
      color: freeReady ? "var(--success)" : "var(--text-dim)"
    }
  }, freeReady ? I18N.t("CAMP_FREE_TODAY") : I18N.t("CAMP_FREE_NEXT", campFreeCompact((g.campaignFreeTs || 0) + 86400000 - Date.now()))), /*#__PURE__*/React.createElement(PostureSelect, {
    value: posture,
    onChange: setPosture,
    disabled: playing
    ...
    onNext: result.win && floorIndex < D.FLOORS_PER_WORLD - 1 ? () => {
      setResult(null);
      onCleared(floorIndex + 1);
    } : null,
    onRetry: () => {
      setResult(null);
    }
...
function CampResultModal({
  ...
  }, win ? I18N.t("CAMP_VICTORY") : I18N.t("CAMP_DEFEAT")), win && /*#__PURE__*/React.createElement("div", {
    style: {
      margin: "8px 0"
    }
  }, /*#__PURE__*/React.createElement(Stars, {
  ...
  }, /*#__PURE__*/React.createElement(CampResRow, {
    label: I18N.t("CAMP_STARS_EARNED", data.stars),
    value: "★".repeat(data.stars),
    color: "var(--gold)"
  }), data.lockedGain > 0 && /*#__PURE__*/React.createElement(CampResRow, {
    fa: true,
    label: "FRACTALARENA \uD83D\uDD12",
    value: "+" + fmt(data.lockedGain),
    color: "var(--success)"
  }), data.commission > 0 && /*#__PURE__*/React.createElement(CampResRow, {
    fa: true,
    label: I18N.t("CHAMP_COMMISSION_ROW", data.champName),
    value: fmt(data.commission),
    color: "var(--elec)"
  }), data.silver > 0 && /*#__PURE__*/React.createElement(CampResRow, {
    label: I18N.t("CAMP_REWARD_SILVER", data.silver),
    value: "\uD83C\uDF9F",
    color: "var(--elec)"
  }), data.gold > 0 && /*#__PURE__*/React.createElement(CampResRow, {
    label: I18N.t("CAMP_REWARD_GOLD", data.gold),
    value: "\uD83C\uDF9F",
    color: "var(--gold)"
  }), data.titleUnlocked && /*#__PURE__*/React.createElement("div", {
    className: "oct-sm",
    style: {
      marginTop: 6,
      padding: "12px 14px",
  ...
  }, I18N.t("CAMP_WORLD_CLEAR", I18N.t(data.titleUnlocked)))), data.legend && /*#__PURE__*/React.createElement("div", {
    className: "oct-sm",
    style: {
      marginTop: 6,
      padding: "12px 14px",
  ...
  }, I18N.t("CAMP_ALL_CLEAR", I18N.t("CAMP_LEGEND_TITLE"))))) : /*#__PURE__*/React.createElement("div", {
    className: "mono",
    style: {
      textAlign: "center",
      color: "var(--text-dim)",
  ...
  }, I18N.t("CAMP_DEFEAT_HINT")), /*#__PURE__*/React.createElement("div", {
    className: "flex gap8",
    style: {
      marginTop: 20
    }
  }, win && onNext ? /*#__PURE__*/React.createElement("button", {
    className: "btn btn-success block lg",
    style: {
      flex: 1
    },
    onClick: onNext
  }, I18N.t("CAMP_NEXT_FLOOR")) : /*#__PURE__*/React.createElement("button", {
    className: cx("btn block lg", win ? "btn-elec" : "btn-fire"),
    style: {
      flex: 1
    },
    onClick: win ? onClose : onRetry
  }, win ? I18N.t("CAMP_CONTINUE") : I18N.t("CAMP_RETRY"))));
}
function CampResRow({
  label,
  value,
...
function FloorSelect({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "btn ghost sm",
    onClick: onBack
  }, I18N.t("CAMP_BACK_WORLDS")), /*#__PURE__*/React.createElement("div", {
    className: "h1",
    style: {
      marginBottom: 0,
      marginTop: 8
  ...
  }, I18N.t("CAMP_STARS", total, D.STARS_PER_WORLD))), /*#__PURE__*/React.createElement("span", {
    className: "pill",
    style: {
      color: "var(--gold)"
    }
  }, I18N.t("CAMP_STARS", total, D.STARS_PER_WORLD))), /*#__PURE__*/React.createElement("div", {
    className: "camp-floor-grid",
    style: {
      display: "grid",
    ...
    return /*#__PURE__*/React.createElement("button", {
    ...
    }, isBoss && /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 10,
        fontWeight: 700,
        color: "var(--gold)",
      ...
      style: {
        fontSize: 22,
        color: isBoss ? "var(--gold)" : "var(--text)"
      }
    ...
    }, I18N.t("CAMP_FLOOR_N", i + 1)), unlocked ? /*#__PURE__*/React.createElement(Stars, {
      n: fs,
      size: 16
    }) : /*#__PURE__*/React.createElement("div", {
      className: "mono",
      ...
      style: {
        ...
        inset: 0,
        pointerEvents: "none",
        boxShadow: "inset 0 0 18px rgba(247,147,26,0.18)"
      }
    }));
  })), /*#__PURE__*/React.createElement("div", {
    className: "muted mono",
  ...
  }, world.type === "MIX" ? "★ Legendary · " : "", I18N.t("CAMP_FLOOR_LOCKED")), /*#__PURE__*/React.createElement("div", {
    className: "mono",
    style: {
      fontSize: 11,
      marginTop: 8,
...
function CampaignTitles() {
  ...
  }, "\uD83C\uDFC5 ", I18N.t("CAMP_TITLES")), titles.length === 0 ? /*#__PURE__*/React.createElement("div", {
    className: "muted mono",
    style: {
      fontSize: 12
    }
  }, I18N.t("CAMP_NO_TITLES")) : /*#__PURE__*/React.createElement("div", {
    className: "flex gap8 wrap"
  }, titles.map(tk => /*#__PURE__*/React.createElement("span", {
    key: tk,
    className: "pill",
    style: {
      color: tk === "CAMP_LEGEND_TITLE" ? "var(--fire)" : "var(--gold)"
    }
...
function Campaign() {
  ...
  if (nav.screen === "floors") {
    return /*#__PURE__*/React.createElement(FloorSelect, {
      worldIndex: nav.world,
      onBack: () => setNav({
        screen: "worlds",
        world: 0,
