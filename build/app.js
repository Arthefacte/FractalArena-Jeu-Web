...
function App() {
  ...
  useEffect(() => {
    if (g.liquid !== prevLiquid.current) {
      prevLiquid.current = g.liquid;
      setChipPop(n => n + 1);
    }
  }, [g.liquid]);
  ...
  const actions = useMemo(() => ({
    ...
    async answerQuiz(questionId, choice) {
      ...
      try {
        ...
        const data = await resp.json();
        if (data.reward > 0) setG(st => ({
          ...st,
          locked: (st.locked || 0) + data.reward
        }));
        return {
          ok: true,
          data
    ...
    async donateQuiz(questionId) {
      ...
      try {
        ...
        if (donne > 0) setG(st => ({
          ...st,
          locked: Math.max(0, (st.locked || 0) - donne)
        }));
        return {
          ok: true,
          data
...
function Onboarding({
  ...
  async function connectManual() {
    const a = addr.trim();
    if (a.length < 20 || !/^bc1/i.test(a)) {
      toast(I18N.t("OB_INVALID"), "bad");
      return;
    }
    setBusy("manual");
    try {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, I18N.t("OB_MANUAL_TOGGLE"))), manual && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 10
    }
    ...
    placeholder: I18N.t("OB_PLACEHOLDER"),
    onKeyDown: e => e.key === "Enter" && connectManual()
  }), /*#__PURE__*/React.createElement("button", {
    className: "btn block",
    disabled: !!busy,
    onClick: connectManual
  }, busy === "manual" ? I18N.t("OB_CHECKING") : I18N.t("OB_BTN"))), /*#__PURE__*/React.createElement("div", {
    className: "lang-switch",
    style: {
      margin: "16px auto 0",
      width: "fit-content"
