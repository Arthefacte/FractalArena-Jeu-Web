/* Généré par tools/precompile.mjs depuis pwa.jsx — NE PAS ÉDITER. */
(function () {
/* ============================================================
...
const lireRefus = () => {
  try {
    return Number(localStorage.getItem(REFUS_CLE)) || null;
  } catch (e) {
    return null;
  }
};
const ecrireRefus = t => {
  try {
    localStorage.setItem(REFUS_CLE, String(t));
  } catch (e) {}
};
...
function PwaInstallBanner({
  ...
  const mode = PWA.installMode({
    ...
    standalone: estInstalle(),
    prompt: !!prompt
  });
  const montrer = !ferme && PWA.doitProposer({
    mode,
    combats: Number(g.totalFights) || 0,
    refusLe,
    maintenant: Date.now()
  });
  ...
  const installer = async () => {
    ...
    try {
      ...
      if (res && res.outcome === "accepted") onInstalled && onInstalled();else plusTard();
    } catch (e) {
      plusTard();
    }
  };
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "pwa-banner-t"
  }, I18N.t("PWA_INSTALL_TITRE")), /*#__PURE__*/React.createElement("div", {
    className: "pwa-banner-p"
  }, mode === "ios" ? I18N.t("PWA_IOS_GESTE") : I18N.t("PWA_INSTALL_TEXTE"))), mode === "invite" && /*#__PURE__*/React.createElement("button", {
    className: "btn sm",
    onClick: installer
  }, I18N.t("PWA_INSTALL_OUI")), /*#__PURE__*/React.createElement("button", {
    className: "btn sm ghost",
    onClick: plusTard
  }, I18N.t("PWA_INSTALL_NON")));
}
...
function PwaOfflineGate({
  ...
  return /*#__PURE__*/React.createElement(Modal, {
    ...
    title: I18N.t("PWA_OFFLINE_TITRE")
  }), /*#__PURE__*/React.createElement("p", {
    style: {
      lineHeight: 1.55
    }
  }, I18N.t("PWA_OFFLINE_TEXTE")), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 14,
      display: "flex",
    ...
    className: "btn",
    onClick: onReessayer
  }, I18N.t("PWA_OFFLINE_REESSAYER"))));
}
Object.assign(window, {
  PwaInstallBanner,
  PwaOfflineGate,
  estInstallePWA: estInstalle
});
})();
