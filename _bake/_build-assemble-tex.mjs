...
const {F,CELL,frames}=JSON.parse(fs.readFileSync(path.join(ROOT,"_bake","_assemble-tex-frames.json"),"utf8"));
...
<div class="stage">
  <div class="note">proto #5 — assemblage 3D des 7 pièces avec la vraie texture transférée (métal + lave + éclairs)</div>
  <div class="boot">
