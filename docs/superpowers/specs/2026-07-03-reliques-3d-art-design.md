...
Consignes communes (à appliquer aux 8) : **un seul objet centré**, vue 3/4, **fond studio neutre uni** (gris moyen, pas le fond sombre du jeu — meilleure extraction de géométrie par Meshy), éclairage studio doux sans ombres dures, matériau PBR net, haute définition, pas de texte, pas de sol/décor. Le style **cristallin-tech** (gemme + circuits lumineux cyan/orange, esprit Tron) et la teinte finale seront de toute façon re-teintés par rareté en jeu — l'image doit surtout donner une **forme et un matériau propres**.

1. **ruby_shard** — « A single faceted octahedral crystal shard, deep red gemstone core with glowing thin circuit lines etched along its edges, sci-fi Tron aesthetic, 3/4 view, centered, neutral studio background, soft lighting, PBR, high detail, one object. »
2. **sapphire_plate** — « A rectangular crystalline tablet/plate, blue sapphire body with an embedded glowing tech circuit pattern on its face, beveled edges, sci-fi Tron aesthetic, 3/4 view, centered, neutral studio background, soft lighting, PBR, high detail, one object. »
3. **quartz_lens** — « A rounded faceted crystal orb (icosahedron-like lens), translucent quartz with an inner glowing core and thin circuit filaments, sci-fi Tron aesthetic, 3/4 view, centered, neutral studio background, soft lighting, PBR, high detail, one object. »
4. **amber_cell** — « A dodecahedral amber crystal cell, warm translucent facets housing a glowing energy core with circuit traces on the seams, sci-fi Tron aesthetic, 3/4 view, centered, neutral studio background, soft lighting, PBR, high detail, one object. »
5. **cobalt_spring** — « A toroidal ring device (torus), cobalt-blue metallic-crystal body wrapped with glowing tech coils and circuit lines, sci-fi Tron aesthetic, 3/4 view, centered, neutral studio background, soft lighting, PBR, high detail, one object. »
6. **onyx_membrane** — « A sharp tetrahedral black onyx crystal, glossy dark facets with glowing cyan circuit veins running across the surfaces, sci-fi Tron aesthetic, 3/4 view, centered, neutral studio background, soft lighting, PBR, high detail, one object. »
7. **jade_circuit** — « An interwoven torus-knot artifact, green jade material braided with glowing circuit filaments following the knot's path, sci-fi Tron aesthetic, 3/4 view, centered, neutral studio background, soft lighting, PBR, high detail, one object. »
8. **prism_matrix** — « A hexagonal pyramidal prism (six-sided cone), multi-faceted iridescent crystal refracting light, thin glowing circuit lines along the vertical edges, sci-fi Tron aesthetic, 3/4 view, centered, neutral studio background, soft lighting, PBR, high detail, one object. »
